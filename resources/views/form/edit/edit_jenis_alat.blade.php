...
@section('content')
@include('layouts.breadcrumbs', ['title' => 'Edit Jenis Alat'])
...
<div class="card" style="padding:12px">
    ...
    <div
        ...
        <form action="{{ route('jenis_alat.update', $jenisalat->jenis_alat_id) }}" method="POST" class="card-body">
            @csrf
            @method('PUT')
            <div class="form-group mb-3">
                ...
                <input type="text" class="form-control" id="jenis_alat_nama" name="jenis_alat_nama"
                    value="{{$jenisalat->jenis_alat_nama}}" required>
            </div>
