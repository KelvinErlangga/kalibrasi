...
@section('content')
@include('layouts.breadcrumbs', ['title' => 'Edit Kategori Alat'])
...
<div class="card" style="padding:12px">
    ...
    <div
        ...
        <form action="{{ route('kategori_alat.update', $kategorialat->kategori_alat_id) }}" method="POST"
            class="card-body">
            @csrf
            @method('PUT')
            <div class="form-group mb-3">
                ...
                <input type="text" class="form-control" id="kategori_alat_nama" name="kategori_alat_nama"
                    value="{{$kategorialat->kategori_alat_nama}}" required>
            </div>
